    ...
    <div class="card-body">
      <blockquote class="relative">
        ...
        <div class="relative z-10">
          <p class="text-gray-800 sm:text-xl"><em>Das Außerordentliche geschieht nicht auf glattem, gewöhnlichem Wege.</em></p>
        </div>

        <footer class="mt-6">
          <div class="flex items-center">
            <div class="shrink-0">
              <img class="size-10 rounded-full" src="/images/goethe.jpg" alt="Johann Wolfgang von Goethe Portrait" />
            </div>
            <div class="ms-4">
              <div class="text-base font-semibold text-gray-800">Johann Wolfgang von Goethe</div>
              <div class="text-xs text-gray-500">Dichter, Politiker und Naturforscher</div>
            </div>
          </div>
        </footer>
      </blockquote>
