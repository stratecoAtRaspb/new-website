...
<svelte:head>
  <title>{m['topics.financeAndControlling.reporting.title']()}</title>
  <meta name="description" content={m['topics.financeAndControlling.reporting.title']()} />
</svelte:head>

<Stage>
  <IntroBox title={m['navigation.topics.reporting']()} description={m['aboutUs.introDescription']()}></IntroBox>
</Stage>

{#snippet left()}
  <div class="prose">
    <h1>{m['navigation.topics.reporting']()}</h1>
