...
{#snippet left()}
  <div class="prose">
    ...
    <p>
      ...
      wir unseren Kunden wertvollen Einblick in seine Geschäftsprozesse zu erlangen. Unsere Business Performance Management Lösungen helfen dem Kunden Prozesseffektivität
      und Effizienz der internen und externen Geschäftsprozesse erzielen.
    </p>
    <h3>Schwerpunkt</h3>
    <ul>
      <li>Optimierung und Realisierung der Controlling Konzepte</li>
      <li>Optimierung und Realisierung der wertorientierten Unternehmensführungskonzepte</li>
      <li>Optimierung und Realisierung der Asset und Risiko Management Konzepten</li>
      <li>Harmonisierung der internen und externen Rechnungswesen Systeme</li>
    </ul>
    <h3>Lösungen</h3>
    <ul>
      <li>Projekteffizienz durch Geschäftsprozess- Strategieworkshops</li>
      <li>Strategie Prüfung oder Snap Shot Analyse</li>
      <li>Definition der Meilensteine für jede Phase und jedes Arbeitspaket</li>
      <li>Benchmark durch unsere Projekt Erfahrung und Marktexpertise</li>
      <li>Skalierbare und modulare Lösungen</li>
    </ul>
    <h3>Branchen</h3>
    <ul>
  ...
  <a href={ resolve(localizeHref('/topics/finance-controlling') as any) }>Zurück zu Übersicht</a>
{/snippet}
